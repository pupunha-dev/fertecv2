...
export default function FailureCauseSection() {
  return (
    <section id="manufatura-tecnica" className="scroll-mt-24 bg-bg-void px-[clamp(1.5rem,5vw,4rem)] py-[clamp(2rem,4vw,3rem)]">
      <motion.div
        initial="hidden"
        whileInView="visible"
      ...
      >
        ...
        <div className="flex flex-col gap-6">
          <motion.div variants={fadeInUp}>
            <SectionTitle as="h2" size="sm">MANUFATURA TÉCNICA</SectionTitle>
          </motion.div>
